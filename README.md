...
[![Godoc](http://img.shields.io/badge/godoc-reference-blue.svg?style=flat)](http://godoc.org/github.com/zuu-development/elastic)
...
See the [wiki](https://github.com/zuu-development/elastic/wiki) for additional information about Elastic.
...
**The release branches (e.g. [`release-branch.v7`](https://github.com/zuu-development/elastic/tree/release-branch.v7))
...
----------------------|------------------|-------------|---------|
7.x                   | 7.0              | [`github.com/zuu-development/elastic`](https://github.com/zuu-development/elastic) ([source](https://github.com/zuu-development/elastic/tree/release-branch.v7) [doc](http://godoc.org/github.com/zuu-development/elastic)) | Use Go modules.
6.x                   | 6.0              | [`github.com/zuu-development/elastic`](https://github.com/zuu-development/elastic) ([source](https://github.com/zuu-development/elastic/tree/release-branch.v6) [doc](http://godoc.org/github.com/zuu-development/elastic)) | Use a dependency manager (see below).
5.x                   | 5.0              | [`gopkg.in/olivere/elastic.v5`](https://gopkg.in/olivere/elastic.v5) ([source](https://github.com/zuu-development/elastic/tree/release-branch.v5) [doc](http://godoc.org/gopkg.in/olivere/elastic.v5)) | Actively maintained.
2.x                   | 3.0              | [`gopkg.in/olivere/elastic.v3`](https://gopkg.in/olivere/elastic.v3) ([source](https://github.com/zuu-development/elastic/tree/release-branch.v3) [doc](http://godoc.org/gopkg.in/olivere/elastic.v3)) | Deprecated. Please update.
1.x                   | 2.0              | [`gopkg.in/olivere/elastic.v2`](https://gopkg.in/olivere/elastic.v2) ([source](https://github.com/zuu-development/elastic/tree/release-branch.v2) [doc](http://godoc.org/gopkg.in/olivere/elastic.v2)) | Deprecated. Please update.
0.9-1.3               | 1.0              | [`gopkg.in/olivere/elastic.v1`](https://gopkg.in/olivere/elastic.v1) ([source](https://github.com/zuu-development/elastic/tree/release-branch.v1) [doc](http://godoc.org/gopkg.in/olivere/elastic.v1)) | Deprecated. Please update.
...
```go
import "github.com/zuu-development/elastic"
```
...
We will use this as an opportunity to [clean up and refactor Elastic](https://github.com/zuu-development/elastic/blob/release-branch.v7/CHANGELOG-7.0.md),
...
and we used this as an opportunity to [clean up and refactor Elastic](https://github.com/zuu-development/elastic/blob/release-branch.v6/CHANGELOG-6.0.md)
...
and we used this as an opportunity to [clean up and refactor Elastic](https://github.com/zuu-development/elastic/blob/release-branch.v5/CHANGELOG-5.0.md)
...
See the [.travis.yml](https://github.com/zuu-development/elastic/blob/master/.travis.yml)
...
The first thing you do is to create a [Client](https://github.com/zuu-development/elastic/blob/master/client.go).
...
1. Head over to the [Wiki](https://github.com/zuu-development/elastic/wiki) for detailed information and
   topics like e.g. [how to add a middleware](https://github.com/zuu-development/elastic/wiki/HttpTransport)
   or how to [connect to AWS](https://github.com/zuu-development/elastic/wiki/Using-with-AWS-Elasticsearch-Service).
...
3. The [recipes](https://github.com/zuu-development/elastic/tree/release-branch.v6/recipes)
...
A pattern for [efficiently scrolling in parallel](https://github.com/zuu-development/elastic/wiki/ScrollParallel)
is described in the [Wiki](https://github.com/zuu-development/elastic/wiki).

## How to contribute

Read [the contribution guidelines](https://github.com/zuu-development/elastic/blob/master/CONTRIBUTING.md).
